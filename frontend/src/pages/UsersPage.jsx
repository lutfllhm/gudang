    ...
    <DashboardLayout>
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="border-b border-slate-200/80 bg-slate-50/90 backdrop-blur-sm">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-200/75 bg-white/75">
                  {users.map((user) => (
                    <tr 
                      key={user.id} 
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#2b2f36] text-sm font-semibold text-white">
                            {user.nama.charAt(0).toUpperCase()}
                          </div>
                          <div className="text-sm font-semibold text-[#2b2f36]">{user.nama}</div>
                        </div>
                      </td>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md overflow-hidden rounded-2xl border border-slate-200/80 bg-white/90 shadow-2xl backdrop-blur-xl">
            {/* Modal Header */}
            <div className="flex items-center justify-between border-b border-slate-200/80 px-5 py-4">
              <h2 className="text-base font-semibold text-[#2b2f36]">Tambah User Baru</h2>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200/80 bg-white/90 px-3 py-2.5 text-sm text-[#2b2f36] placeholder:text-slate-400 shadow-sm backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-red-700/20"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border border-slate-200/80 bg-white/90 px-3 py-2.5 pr-11 text-sm text-[#2b2f36] placeholder:text-slate-400 shadow-sm backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-red-700/20"
